...
import uk.gov.justice.digital.hmpps.nomismappingservice.movements.taps.schedule.ExternalMovementMappingDto
import uk.gov.justice.digital.hmpps.nomismappingservice.movements.taps.schedule.ScheduledMovementMappingDto
...
import uk.gov.justice.digital.hmpps.nomismappingservice.movements.taps.schedule.TemporaryAbsenceApplicationMappingDto
...
class TemporaryAbsenceService(
  ...
  @Transactional
  suspend fun createApplicationMapping(mappingDto: TemporaryAbsenceApplicationSyncMappingDto) {
  ...
  @Transactional
  suspend fun createScheduledMovementMapping(mappingDto: ScheduledMovementSyncMappingDto) {
  ...
  @Transactional
  suspend fun createExternalMovementMapping(mappingDto: ExternalMovementSyncMappingDto) {
    movementRepository.save(mappingDto.toMapping())
  }

  @Transactional
  suspend fun updateExternalMovementMapping(mappingDto: ExternalMovementSyncMappingDto) {
