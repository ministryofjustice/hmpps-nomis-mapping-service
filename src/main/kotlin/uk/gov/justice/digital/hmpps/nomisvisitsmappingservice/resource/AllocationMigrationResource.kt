...
class AllocationMigrationResource(private val mappingService: AllocationMigrationService) {
  ...
  @Operation(
    ...
    description = "Creates a mapping between nomis allocation id and DPS allocation id. Requires NOMIS_ACTIVITIES",
    ...
    responses = [
      ...
      ApiResponse(
        responseCode = "400",
        description = "Nomis or DPS allocation ids already exist",
  ...
  @Operation(
    ...
    description = "Retrieves an allocation migration mapping by allocation id. Requires role NOMIS_ACTIVITIES",
    responses = [
      ApiResponse(
        responseCode = "200",
  ...
  @PreAuthorize("hasRole('ROLE_NOMIS_ACTIVITIES')")
  @GetMapping("/mapping/allocations/migration/migrated/latest")
  @Operation(
