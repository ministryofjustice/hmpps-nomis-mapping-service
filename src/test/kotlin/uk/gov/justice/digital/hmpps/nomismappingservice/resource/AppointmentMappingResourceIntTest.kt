...
import uk.gov.justice.digital.hmpps.nomismappingservice.jpa.AppointmentMappingType.APPOINTMENT_CREATED
import uk.gov.justice.digital.hmpps.nomismappingservice.jpa.AppointmentMappingType.MIGRATED
...
class AppointmentMappingResourceIntTest : IntegrationTestBase() {
  ...
  fun setup() {
    ...
    ReflectionTestUtils.setField(appointmentMappingService, "appointmentMappingRepository", repository)
  }
