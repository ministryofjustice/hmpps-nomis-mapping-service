...
class CorePersonMappingResource(private val service: CorePersonService) {
  ...
  @GetMapping("/religion/nomis-religion-id/{nomisReligionId}")
  @Operation(
    summary = "Get a core person religion mapping by nomis religion Id",
    description = "Retrieves the coreperson religion mapping by NOMIS Religion Id. Requires role ROLE_NOMIS_MAPPING_API__SYNCHRONISATION__RW",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "Core Person religion mapping data",
      ),
      ApiResponse(
        responseCode = "401",
        description = "Unauthorized to access this endpoint",
  ...
  suspend fun getReligionMappingByNomisId(
    @Schema(description = "NOMIS religion id", example = "12345", required = true)
    @PathVariable
    nomisReligionId: Long,
  ): CorePersonReligionMappingDto = service.getReligionMappingByNomisId(nomisId = nomisReligionId)

  @GetMapping("/religion/cpr-religion-id/{cprReligionId}")
  @Operation(
    summary = "Get core person religion mapping by cpr religion Id",
    description = "Retrieves the core person religion mapping by CPR Religion Id. Requires role ROLE_NOMIS_MAPPING_API__SYNCHRONISATION__RW",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "Core Person religion mapping data",
  ...
  suspend fun getReligionMappingByCprId(
    @Schema(description = "CPR religion id", example = "12345", required = true)
    @PathVariable
    cprReligionId: String,
  ): CorePersonReligionMappingDto = service.getReligionMappingByCprId(cprId = cprReligionId)
}
