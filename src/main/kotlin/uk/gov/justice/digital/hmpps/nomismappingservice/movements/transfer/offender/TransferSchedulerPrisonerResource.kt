...
class TransferSchedulerPrisonerResource(
  ...
  suspend fun getTransferSchedulerBookingMappings(
    @PathVariable
    bookingId: Long,
  ): TransferSchedulerMoveBookingMappingDto = service.getMappingsForMoveBooking(bookingId)
  ...
  suspend fun moveTransferSchedulerBookingMappings(
